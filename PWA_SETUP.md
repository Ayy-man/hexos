...
### 1. Custom App Icon/Logo
**Current:** Using auto-generated placeholder icons from favicon
**Improvement:** Design proper hexOS logo icons with:
- Clean, recognizable logo that works at small sizes
- Proper maskable icon with safe zone for Android adaptive icons
...
**Tool:** Use https://maskable.app/editor to test maskable icons

### 2. Status Bar / Theme Colors
**Current:** Purple theme (#8860d0) affects status bar on Android, "black-translucent" on iOS
**Improvement:** Adjust colors for better appearance:

**Option A:** Match app background
```json
// manifest.json
"theme_color": "#ffffff",  // or dark mode color
"background_color": "#ffffff"
```

**Option B:** Subtle brand color
```json
"theme_color": "#1a1a2e",  // darker, less jarring
```

**For iOS status bar**, edit `app/layout.tsx`:
```typescript
appleWebApp: {
...
### 3. Splash Screen (iOS)
**Current:** No custom splash screen
**Improvement:** Add Apple splash screen images for seamless app launch

```bash
npx pwa-asset-generator logo.png public/ --splash-only --background "#8860d0"
```
