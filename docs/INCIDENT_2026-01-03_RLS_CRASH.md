...
- [x] Re-enable shared_to field checking (Migration `20260114000001_restore_shared_to_checking.sql`)
- [ ] Add database monitoring/alerts
- [x] Document RLS function guidelines for future development (See `docs/DATABASE_RECOVERY_2026-01-05.md`)
