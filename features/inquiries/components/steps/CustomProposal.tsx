    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <QuestionGroup label="Is there a hard deadline?" required>
            <div className="flex gap-2" data-field="urgency">
              {[
                { value: 'asap', label: 'Yes, < 7 days' },
                { value: 'thirty_days', label: 'Yes, < 30 days' },
                { value: 'exploratory', label: 'No deadline' },
              ].map((opt) => (
                <button
                  key={opt.value}
                  type="button"
