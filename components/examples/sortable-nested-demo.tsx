...
/**
 * Sortable Nested Demo
 *
 * Example showing how to use the Sortable component for nested drag-and-drop lists.
 * Use cases:
 * - Option groups with values (like product variants)
 * - Categories with items
 * - Folders with files
 * - Any hierarchical data that needs reordering
 *
 * To use: Copy this pattern and adapt the data types to your needs.
 */
...
export default function SortableNestedDemo() {
